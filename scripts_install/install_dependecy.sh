...
apt-get install python-pypdf2 python-pip python-arrow python-vobject python-webdav python-ldap3 python-wrapt python-setuptools python-werkzeug python-lxml python-relatorio python-genshi python-dateutil python-polib python-psycopg2 python-pydot unoconv python-sphinx python-levenshtein python-bcrypt
